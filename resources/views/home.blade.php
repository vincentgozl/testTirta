...
<head>
    ...
    <title>Tirtakencana Tatawarna</title>
    ...
    <link href="{{ asset('startbootstrap-sb-admin-2-gh-pages/css/dataTables.bootstrap4.css') }}" rel="stylesheet">
    <link href="{{ asset('startbootstrap-sb-admin-2-gh-pages/vendor/bootstrap/bootstrap.scss') }}" rel="stylesheet">
    <link href="{{ asset('startbootstrap-sb-admin-2-gh-pages/vendor/bootstrap/scss/_nav.scss') }}" rel="stylesheet">
    <link href="{{ asset('startbootstrap-sb-admin-2-gh-pages/vendor/bootstrap/scss/_navbar.scss') }}" rel="stylesheet">
    <link href="{{ asset('startbootstrap-sb-admin-2-gh-pages/vendor/fontawesome-free/css/all.css') }}" rel="stylesheet">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/">
                ...
                <div class="sidebar-brand-text mx-3">Tirtakencana Tatawarna</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('toko.index') }}">All Data Toko</a>
                        <a class="collapse-item" href="{{ route('toko.create') }}">Tambah Toko</a>
                        {{-- <a class="collapse-item" href="cards.html">Update Toko</a> --}}
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Option</h6>
                        <a class="collapse-item" href="{{ route('areasales.index') }}">All Area Sales</a>
                        <a class="collapse-item" href="{{ route('areasales.create') }}">Tambah Area Sales</a>
                        {{-- <a class="collapse-item" href="cards.html">Update Area Sales</a> --}}
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Option</h6>
                        <a class="collapse-item" href="{{ route('sales.index') }}">All Sales</a>
                        <a class="collapse-item" href="{{ route('sales.create') }}">Tambah Sales</a>
                        {{-- <a class="collapse-item" href="cards.html">Update Sales</a> --}}
                    </div>
                </div>
            </li>
